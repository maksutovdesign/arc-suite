...
import { APIS_ALL, CATEGORIES, STATS, API_VOLUME, FEATURED_IDS } from "@/data/mock"
...
export default function BrowsePage() {
  ...
  const featuredApis = APIS_ALL.filter(a => FEATURED_IDS.includes(a.id))
          ...
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <p className="text-sm" style={{ color: "#7a8fa8" }}>
                {allApis.length} APIs · {STATS.totalProviders} providers · No subscriptions — pay per use with USDC
              </p>
            </div>
