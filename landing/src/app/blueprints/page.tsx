...
const blueprints = [
  ...
  },
  {
    ...
    category: "RWA / Credit",
    source: "GetLiquid pattern",
    modules: ["Credit", "Escrow", "Shield", "Flow"],
    steps: ["Onboard parties", "Screen facility", "Schedule repayments", "Record proof"],
    status: "Built surface",
  },
  {
    icon: CircleDollarSign,
    name: "FX Settlement Desk",
    category: "FX / Perps",
    source: "Hibachi / QCAD pattern",
    modules: ["Treasury", "Shield", "Flow", "Gas"],
    steps: ["Stream market data", "Check risk", "Settle collateral", "Attach trace proof"],
    status: "Opportunity",
  },
  {
    icon: Boxes,
...
const primitives = [
  ...
  ["Ledger", "Hardware-backed transaction review and clear signing path"],
  ["QuickNode", "HTTP, WSS, archive, debug and trace infrastructure"],
